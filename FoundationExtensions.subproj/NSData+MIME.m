...
- (NSData *)encodeContentWithTransferEncoding:(NSString *)encodingName
{
    ...
    [NSException raise:NSInvalidArgumentException format:@"-[%@ %@]: Unknown content transfer encoding; found '%@'", NSStringFromClass( EDObjcIsa), NSStringFromSelector(_cmd), encodingName];
